...
export default function CreateCustomGamePage() {
    ...
    async function onSubmit(data: z.infer<typeof CreateCustomGameSchema>) {
        ...
        console.log("Creating custom game with data:", data);
        ...
        console.log("Custom Game Data to be submitted:", customGameData);

        const { error } = await $fetch("@post/dashboard/custom-level/create", {
            body: customGameData,
            credentials: "include",
        });
        ...
        if (error) {
            ...
            toast.error("Failed to create custom game");
            setIsSubmitting(false);
            return;
        }

        toast.success("Custom game created successfully");
        router.push("/dashboard/custom-games");
    }
